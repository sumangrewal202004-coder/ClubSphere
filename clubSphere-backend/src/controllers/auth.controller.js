...
exports.sendOtp = async (req, res) => {
  ...
  try {
    ...
    // ─── FIX: Always send to the real user email ───────────────────────────
    // Previously, DEV_MODE redirect caused OTPs to go to a single fixed email
    // instead of the actual user. Removed that override entirely.
    // Resend free tier restriction: you must verify recipient emails in your
